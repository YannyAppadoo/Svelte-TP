...
<div id="modal" class="modal" style="--modal-state: {modalState}">
	<div id="modal-content" class="modal-content">
		...
		<h2>Alerte</h2>
		<p>
            Afficher instantanément le nombre de caractères d'un texte saisie dans un champ de formulaire.
			Utiliser la propriété Bind sur la valeur saisie dans un textarea pour déterminer sa taille.
		</p>

...
<div id="modal" class="modal" style="--modal-state: {modalState}">
	<div id="modal-content" class="modal-content">
		...
		<h2>Todo List</h2>
		<p>
            Etablir une « To Do list » permet de mettre au clair ses pensées tout en établissant un programme précis de petites actions à accomplir.
            <br>
            Dans ce cas la, il est possible d'ajouter, valider ou supprimer une tâches.
			Lister les tâches dans un tableau et utilisation de de fonction ADD et REMOVE.
		</p>
	</div>
</div>

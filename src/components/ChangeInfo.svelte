...
<div id="modal" class="modal" style="--modal-state: {modalState}">
	<div id="modal-content" class="modal-content">
		...
		<h2>Avant / Après</h2>
		<p>
            Composant qui permet d'intervertir des image grâce à un simple clic.
			Valeur booléen fausse sur les premiéres images, avec le toggle bascule la valeur de fausse à true qui change l'image avec.
		</p>
	</div>
</div>

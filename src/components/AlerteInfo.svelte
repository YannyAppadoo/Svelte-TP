...
<div id="modal" class="modal" style="--modal-state: {modalState}">
	<div id="modal-content" class="modal-content">
		...
		<h2>Alerte</h2>
		<p>
            Créer une notification qui apparait puis disparait après un certain temps défini et qui peut se fermer manuellement.
			Faire apparaître la notification avec une transition en fonction de la valeur d'une variable booleène.
			Grâce au click, je change l'état de la notification qui s'affiche et déclenche un compte à rebours pour fermer la fenetre.
			</p>
	</div>
</div>
